<x-plantilla>
    ...
    <div class="p-8 rounded border border-gray-200">
        <h1 class="font-medium text-3xl">Agregar Entrada:</h1>
        <form action="{{ route('entradas.store') }}" method="POST">
            @csrf
            <div class="mt-8 grid lg:grid-cols-2 gap-4">
                <div> <label for="productos_id" class="text-sm text-gray-700 block mb-1 font-medium">Productos</label>
                    <select name="productos_id[]" multiple required
